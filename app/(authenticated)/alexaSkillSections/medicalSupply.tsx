          ...
          <View style={styles.modalContent}>
            <ScrollView>
              ...
              <TextInput
                ...
                onChangeText={v => setAddForm(f => ({ ...f, expiration_date: v }))}
              />
              <TextInput
                style={styles.input}
              ...
              />
              <Text style={styles.modalLabel}>Unit of Measure</Text>
              <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ marginBottom: 8 }}>
                {UNITS.map(unit => (
                  <TouchableOpacity
                    key={unit}
                    style={[styles.selectOption, addForm.unit_of_measure === unit && styles.selectedOption]}
                    onPress={() => setAddForm(f => ({ ...f, unit_of_measure: unit }))}
                  >
              ...
              <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ marginBottom: 8 }}>
                {CATEGORIES.map(cat => (
                  <TouchableOpacity
                    key={cat}
                    style={[styles.selectOption, addForm.category === cat && styles.selectedOption]}
